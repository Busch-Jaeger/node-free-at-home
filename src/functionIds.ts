export enum FunctionIds {
    ...
    FID_ROOM_TEMPERATURE_CONTROLLER_WITH_FAN_TYPE1 = 0x00E4,
    FID_ROOM_TEMPERATURE_CONTROLLER_WITHOUT_FAN_TYPE1 = 0x00E5,
    FID_HEATING_ACTUATOR_TYPE1 = 0x00E6,
    FID_TWO_LEVEL_HEATING_ACTUATOR_TYPE1 = 0x00E7,
    FID_COOLING_ACTUATOR_TYPE1 = 0x00E8,
    FID_TWO_LEVEL_COOLING_ACTUATOR_TYPE1 = 0x00E9,
    FID_HEATING_COOLING_ACTUATOR_TYPE1 = 0x00EA,
    FID_TWO_LEVEL_HEATING_COOLING_ACTUATOR_TYPE1 = 0x00EB,
    FID_RGB_CT_ACTUATOR_TYPE8 = 0x00EC,
    FID_ROOM_TEMPERATURE_CONTROLLER_PROXY_WITHOUT_FAN = 0x00ED,
    FID_ROOM_TEMPERATURE_CONTROLLER_EXTENSION_PROXY = 0x00EE,
    FID_HVAC_WITH_ENERGY = 0x00EF,
    FID_SWITCH_ACTUATOR_TYPE1 = 0x00F0,
    FID_SPLIT_UNIT = 0x00F1,
    FID_SENSOR_ZONE = 0x00F2,
    FID_AIRQUALITY_SENSOR_TYPE1 = 0x00F3,
    FID_ENERGY_SUBMETER = 0x00F4,
    FID_PANEL_SWITCH_SENSOR_PUSHBUTTON_TYPE4 = 0x00F5,
    FID_PANEL_DIMMING_SENSOR_PUSHBUTTON_TYPE2 = 0x00F6,
    FID_PANEL_BLIND_SENSOR_PUSHBUTTON_TYPE2 = 0x00F7,
    FID_PANEL_STAIRCASE_LIGHT_SENSOR_PUSHBUTTON_TYPE2 = 0x00F8,
    FID_PANEL_FORCE_ON_OFF_SENSOR_PUSHBUTTON_TYPE4 = 0x00F9,
    FID_PANEL_FORCE_UP_DOWN_SENSOR_PUSHBUTTON_TYPE4 = 0x00FA,
    FID_PANEL_SCENE_SENSOR_PUSHBUTTON_TYPE2 = 0x00FB,
    FID_PANEL_TIMER_ACTION_SENSOR_PUSHBUTTON_TYPE4 = 0x00FC,
    FID_PANEL_MEDIA_PLAY_PAUSE_SENSOR_PUSHBUTTON_TYPE2 = 0x00FD,
    FID_PANEL_MEDIA_NEXT_FAVORITE_SENSOR_PUSHBUTTON_TYPE2 = 0x00FE,
    FID_PANEL_MEDIA_NEXT_SONG_SENSOR_PUSHBUTTON_TYPE2 = 0x00FF,
    FID_PANEL_MEDIA_PREVIOUS_SONG_SENSOR_PUSHBUTTON_TYPE2 = 0x0100,
    FID_PANEL_MEDIA_VOLUME_UP_SENSOR_PUSHBUTTON_TYPE2 = 0x0101,
    FID_PANEL_MEDIA_VOLUME_DOWN_SENSOR_PUSHBUTTON_TYPE2 = 0x0102,
    FID_PANEL_MOVEMENT_DETECTOR_TYPE2 = 0x0103,
    FID_PANEL_WINDOW_DOOR_SENSOR = 0x0104,
    FID_PANEL_HEATING_COOLING_SENSOR = 0x0105,
    FID_PANEL_FROST_ALARM_SENSOR = 0x0106,
    FID_PANEL_RAIN_ALARM_SENSOR = 0x0107,
    FID_PANEL_WIND_ALARM_SENSOR = 0x0108,
    FID_PANEL_FLOOD_ALARM_SENSOR = 0x0109,
    FID_AIRQUALITY_ACTUATOR = 0x010A,
    FID_DOOR_OPENER_ACTUATOR_TYPE0 = 0x010B,
    FID_DOOR_OPENER_ACTUATOR_TYPE1 = 0x010C,
    FID_SPLIT_UNIT_EXTENSION_UNIT = 0x010D,
    FID_DOOR_RINGING_SENSOR = 0x010E,
    FID_CARD_READER = 0x010F,
    FID_AIRQUALITY_SENSOR_TYPE2 = 0x0110,
    FID_ROOM_TEMPERATURE_CONTROLLER_API = 0x0111,
    FID_WINDOW_DOOR_SENSOR_TYPE0 = 0x0112,
    FID_WINDOW_DOOR_SENSOR_TYPE1 = 0x0113,
    FID_WINDOW_DOOR_SENSOR_API = 0x0114,
    FID_MOVEMENT_DETECTOR_API = 0x0115,
    FID_ENVIRONMENT_SENSOR_API = 0x0116,
    FID_ROOM_TEMPERATURE_CONTROLLER_MASTER_WITH_FAN_TYPE1 = 0x0117,
    FID_ROOM_TEMPERATURE_CONTROLLER_MASTER_WITHOUT_FAN_TYPE1 = 0x0118,
    FID_ROOM_TEMPERATURE_CONTROLLER_SLAVE_TYPE1 = 0x0119,
    FID_ROOM_TEMPERATURE_CONTROLLER_SLAVE_API = 0x011A,
    FID_CLOCK = 0x011B,
    FID_HOUSEKEEPING_API = 0x011C,
    FID_AC_PINCODE_SENSOR = 0x011D,
    FID_AC_NFC_SENSOR = 0x011E,
    FID_AC_FINGERPRINT_SENSOR = 0x011F,
    FID_AC_BLUETOOTH_SENSOR = 0x0120,
    FID_SWITCH_SENSOR_ROCKER_TYPE0 = 0x1000,
    FID_SWITCH_SENSOR_ROCKER_TYPE1 = 0x1001,
    FID_SWITCH_SENSOR_ROCKER_TYPE2 = 0x1002,
    FID_SWITCH_SENSOR_ROCKER_TYPE3 = 0x1003,
    FID_SWITCH_SENSOR_ROCKER_TYPE4 = 0x1004,
    FID_SWITCH_SENSOR_ROCKER_TYPE5 = 0x1005,
    FID_SWITCH_SENSOR_ROCKER_TYPE6 = 0x1006,
    FID_SWITCH_SENSOR_ROCKER_TYPE7 = 0x1007,
    ...
    FID_SWITCH_SENSOR_PUSHBUTTON_TYPE4 = 0x100C,
    FID_SWITCH_SENSOR_PUSHBUTTON_TYPE5 = 0x100D,
    FID_SWITCH_SENSOR_PUSHBUTTON_TYPE6 = 0x100E,
    FID_SWITCH_SENSOR_PUSHBUTTON_TYPE7 = 0x100F,
    FID_DIMMING_SENSOR_ROCKER_TYPE0 = 0x1010,
    FID_DIMMING_SENSOR_ROCKER_TYPE1 = 0x1011,
    FID_DIMMING_SENSOR_ROCKER_TYPE2 = 0x1012,
    FID_DIMMING_SENSOR_ROCKER_TYPE3 = 0x1013,
    FID_DIMMING_SENSOR_ROCKER_TYPE4 = 0x1014,
    FID_DIMMING_SENSOR_ROCKER_TYPE5 = 0x1015,
    FID_DIMMING_SENSOR_ROCKER_TYPE6 = 0x1016,
    FID_DIMMING_SENSOR_ROCKER_TYPE7 = 0x1017,
    ...
    FID_DIMMING_SENSOR_PUSHBUTTON_TYPE4 = 0x101C,
    FID_DIMMING_SENSOR_PUSHBUTTON_TYPE5 = 0x101D,
    FID_DIMMING_SENSOR_PUSHBUTTON_TYPE6 = 0x101E,
    FID_DIMMING_SENSOR_PUSHBUTTON_TYPE7 = 0x101F,
    ...
    FID_STAIRCASE_LIGHT_SENSOR_ROCKER_TYPE3 = 0x1023,
    FID_STAIRCASE_LIGHT_SENSOR_ROCKER_TYPE4 = 0x1024,
    FID_STAIRCASE_LIGHT_SENSOR_ROCKER_TYPE5 = 0x1025,
    FID_STAIRCASE_LIGHT_SENSOR_ROCKER_TYPE6 = 0x1026,
    FID_STAIRCASE_LIGHT_SENSOR_ROCKER_TYPE7 = 0x1027,
    ...
    FID_STAIRCASE_LIGHT_SENSOR_PUSHBUTTON_TYPE4 = 0x102C,
    FID_STAIRCASE_LIGHT_SENSOR_PUSHBUTTON_TYPE5 = 0x102D,
    FID_STAIRCASE_LIGHT_SENSOR_PUSHBUTTON_TYPE6 = 0x102E,
    FID_STAIRCASE_LIGHT_SENSOR_PUSHBUTTON_TYPE7 = 0x102F,
    FID_SCENE_SENSOR_ROCKER_TYPE0 = 0x1030,
    FID_SCENE_SENSOR_ROCKER_TYPE1 = 0x1031,
    FID_SCENE_SENSOR_ROCKER_TYPE2 = 0x1032,
    FID_SCENE_SENSOR_ROCKER_TYPE3 = 0x1033,
    FID_SCENE_SENSOR_ROCKER_TYPE4 = 0x1034,
    FID_SCENE_SENSOR_ROCKER_TYPE5 = 0x1035,
    FID_SCENE_SENSOR_ROCKER_TYPE6 = 0x1036,
    FID_SCENE_SENSOR_ROCKER_TYPE7 = 0x1037,
    ...
    FID_SCENE_SENSOR_PUSHBUTTON_TYPE4 = 0x103C,
    FID_SCENE_SENSOR_PUSHBUTTON_TYPE5 = 0x103D,
    FID_SCENE_SENSOR_PUSHBUTTON_TYPE6 = 0x103E,
    FID_SCENE_SENSOR_PUSHBUTTON_TYPE7 = 0x103F,
    FID_BLIND_SENSOR_ROCKER_TYPE0 = 0x1040,
    FID_BLIND_SENSOR_ROCKER_TYPE1 = 0x1041,
    FID_BLIND_SENSOR_ROCKER_TYPE2 = 0x1042,
    FID_BLIND_SENSOR_ROCKER_TYPE3 = 0x1043,
    FID_BLIND_SENSOR_ROCKER_TYPE4 = 0x1044,
    FID_BLIND_SENSOR_ROCKER_TYPE5 = 0x1045,
    FID_BLIND_SENSOR_ROCKER_TYPE6 = 0x1046,
    FID_BLIND_SENSOR_ROCKER_TYPE7 = 0x1047,
    ...
    FID_BLIND_SENSOR_PUSHBUTTON_TYPE4 = 0x104C,
    FID_BLIND_SENSOR_PUSHBUTTON_TYPE5 = 0x104D,
    FID_BLIND_SENSOR_PUSHBUTTON_TYPE6 = 0x104E,
    FID_BLIND_SENSOR_PUSHBUTTON_TYPE7 = 0x104F,
    ...
    FID_FORCE_ON_OFF_SENSOR_ROCKER_TYPE3 = 0x1053,
    FID_FORCE_ON_OFF_SENSOR_ROCKER_TYPE4 = 0x1054,
    FID_FORCE_ON_OFF_SENSOR_ROCKER_TYPE5 = 0x1055,
    FID_FORCE_ON_OFF_SENSOR_ROCKER_TYPE6 = 0x1056,
    FID_FORCE_ON_OFF_SENSOR_ROCKER_TYPE7 = 0x1057,
    ...
    FID_FORCE_ON_OFF_SENSOR_PUSHBUTTON_TYPE4 = 0x105C,
    FID_FORCE_ON_OFF_SENSOR_PUSHBUTTON_TYPE5 = 0x105D,
    FID_FORCE_ON_OFF_SENSOR_PUSHBUTTON_TYPE6 = 0x105E,
    FID_FORCE_ON_OFF_SENSOR_PUSHBUTTON_TYPE7 = 0x105F,
    ...
    FID_FORCE_UP_DOWN_SENSOR_ROCKER_TYPE3 = 0x1063,
    FID_FORCE_UP_DOWN_SENSOR_ROCKER_TYPE4 = 0x1064,
    FID_FORCE_UP_DOWN_SENSOR_ROCKER_TYPE5 = 0x1065,
    FID_FORCE_UP_DOWN_SENSOR_ROCKER_TYPE6 = 0x1066,
    FID_FORCE_UP_DOWN_SENSOR_ROCKER_TYPE7 = 0x1067,
    ...
    FID_FORCE_UP_DOWN_SENSOR_PUSHBUTTON_TYPE4 = 0x106C,
    FID_FORCE_UP_DOWN_SENSOR_PUSHBUTTON_TYPE5 = 0x106D,
    FID_FORCE_UP_DOWN_SENSOR_PUSHBUTTON_TYPE6 = 0x106E,
    FID_FORCE_UP_DOWN_SENSOR_PUSHBUTTON_TYPE7 = 0x106F,
    ...
    FID_TIMER_ACTION_SENSOR_ROCKER_TYPE3 = 0x1073,
    FID_TIMER_ACTION_SENSOR_ROCKER_TYPE4 = 0x1074,
    FID_TIMER_ACTION_SENSOR_ROCKER_TYPE5 = 0x1075,
    FID_TIMER_ACTION_SENSOR_ROCKER_TYPE6 = 0x1076,
    FID_TIMER_ACTION_SENSOR_ROCKER_TYPE7 = 0x1077,
    ...
    FID_TIMER_ACTION_SENSOR_PUSHBUTTON_TYPE4 = 0x107C,
    FID_TIMER_ACTION_SENSOR_PUSHBUTTON_TYPE5 = 0x107D,
    FID_TIMER_ACTION_SENSOR_PUSHBUTTON_TYPE6 = 0x107E,
    FID_TIMER_ACTION_SENSOR_PUSHBUTTON_TYPE7 = 0x107F,
    ...
    FID_MOVEMENT_DETECTOR_TYPE5 = 0x1097,
    FID_MOVEMENT_DETECTOR_TYPE6 = 0x1098,
    FID_MOVEMENT_DETECTOR_TYPE7 = 0x1099,
    FID_MOVEMENT_DETECTOR_TYPE8 = 0x109A,
    FID_MOVEMENT_DETECTOR_TYPE9 = 0x109B,
    FID_MOVEMENT_DETECTOR_TYPE10 = 0x109C,
    ...
    FID_MEDIA_PLAYBACK_CONTROL_SENSOR_ROCKER_TYPE3 = 0x10A3,
    FID_MEDIA_PLAYBACK_CONTROL_SENSOR_ROCKER_TYPE4 = 0x10A4,
    FID_MEDIA_PLAYBACK_CONTROL_SENSOR_ROCKER_TYPE5 = 0x10A5,
    FID_MEDIA_PLAYBACK_CONTROL_SENSOR_ROCKER_TYPE6 = 0x10A6,
    FID_MEDIA_PLAYBACK_CONTROL_SENSOR_ROCKER_TYPE7 = 0x10A7,
    ...
    FID_MEDIA_PLAY_PAUSE_SENSOR_PUSHBUTTON_TYPE4 = 0x10AC,
    FID_MEDIA_PLAY_PAUSE_SENSOR_PUSHBUTTON_TYPE5 = 0x10AD,
    FID_MEDIA_PLAY_PAUSE_SENSOR_PUSHBUTTON_TYPE6 = 0x10AE,
    FID_MEDIA_PLAY_PAUSE_SENSOR_PUSHBUTTON_TYPE7 = 0x10AF,
    ...
    FID_MEDIA_VOLUME_SENSOR_ROCKER_TYPE3 = 0x10B3,
    FID_MEDIA_VOLUME_SENSOR_ROCKER_TYPE4 = 0x10B4,
    FID_MEDIA_VOLUME_SENSOR_ROCKER_TYPE5 = 0x10B5,
    FID_MEDIA_VOLUME_SENSOR_ROCKER_TYPE6 = 0x10B6,
    FID_MEDIA_VOLUME_SENSOR_ROCKER_TYPE7 = 0x10B7,
    ...
    FID_MEDIA_VOLUME_UP_SENSOR_PUSHBUTTON_TYPE4 = 0x10BC,
    FID_MEDIA_VOLUME_UP_SENSOR_PUSHBUTTON_TYPE5 = 0x10BD,
    FID_MEDIA_VOLUME_UP_SENSOR_PUSHBUTTON_TYPE6 = 0x10BE,
    FID_MEDIA_VOLUME_UP_SENSOR_PUSHBUTTON_TYPE7 = 0x10BF,
    ...
    FID_MEDIA_VOLUME_DOWN_SENSOR_PUSHBUTTON_TYPE4 = 0x10C4,
    FID_MEDIA_VOLUME_DOWN_SENSOR_PUSHBUTTON_TYPE5 = 0x10C5,
    FID_MEDIA_VOLUME_DOWN_SENSOR_PUSHBUTTON_TYPE6 = 0x10C6,
    FID_MEDIA_VOLUME_DOWN_SENSOR_PUSHBUTTON_TYPE7 = 0x10C7,
    ...
    FID_MEDIA_NEXT_FAVORITE_SENSOR_PUSHBUTTON_TYPE4 = 0x10CC,
    FID_MEDIA_NEXT_FAVORITE_SENSOR_PUSHBUTTON_TYPE5 = 0x10CD,
    FID_MEDIA_NEXT_FAVORITE_SENSOR_PUSHBUTTON_TYPE6 = 0x10CE,
    FID_MEDIA_NEXT_FAVORITE_SENSOR_PUSHBUTTON_TYPE7 = 0x10CF,
    ...
    FID_MEDIA_NEXT_SONG_SENSOR_PUSHBUTTON_TYPE4 = 0x10D4,
    FID_MEDIA_NEXT_SONG_SENSOR_PUSHBUTTON_TYPE5 = 0x10D5,
    FID_MEDIA_NEXT_SONG_SENSOR_PUSHBUTTON_TYPE6 = 0x10D6,
    FID_MEDIA_NEXT_SONG_SENSOR_PUSHBUTTON_TYPE7 = 0x10D7,
    ...
    FID_MEDIA_PREVIOUS_SONG_SENSOR_PUSHBUTTON_TYPE4 = 0x10DC,
    FID_MEDIA_PREVIOUS_SONG_SENSOR_PUSHBUTTON_TYPE5 = 0x10DD,
    FID_MEDIA_PREVIOUS_SONG_SENSOR_PUSHBUTTON_TYPE6 = 0x10DE,
    FID_MEDIA_PREVIOUS_SONG_SENSOR_PUSHBUTTON_TYPE7 = 0x10DF,
    ...
    FID_LOCK_SENSOR_SENSOR_ROCKER_TYPE3 = 0x1173,
    FID_LOCK_SENSOR_SENSOR_ROCKER_TYPE4 = 0x1174,
    FID_LOCK_SENSOR_SENSOR_ROCKER_TYPE5 = 0x1175,
    FID_LOCK_SENSOR_SENSOR_ROCKER_TYPE6 = 0x1176,
    FID_LOCK_SENSOR_SENSOR_ROCKER_TYPE7 = 0x1177,
    ...
    FID_LOCK_SENSOR_SENSOR_PUSHBUTTON_TYPE4 = 0x117C,
    FID_LOCK_SENSOR_SENSOR_PUSHBUTTON_TYPE5 = 0x117D,
    FID_LOCK_SENSOR_SENSOR_PUSHBUTTON_TYPE6 = 0x117E,
    FID_LOCK_SENSOR_SENSOR_PUSHBUTTON_TYPE7 = 0x117F,
    FID_TEMPERATURE_ADJUSTMENT_SENSOR_ROCKER_TYPE0 = 0x1180,
    FID_TEMPERATURE_ADJUSTMENT_SENSOR_ROCKER_TYPE7 = 0x1187,
    FID_OPERATION_MODE_ADJUSTMENT_SENSOR_ROCKER_TYPE0 = 0x1190,
    FID_OPERATION_MODE_ADJUSTMENT_SENSOR_ROCKER_TYPE7 = 0x1197,
    FID_OPERATION_MODE_ADJUSTMENT_SENSOR_PUSHBUTTON_TYPE2 = 0x11A2,
    FID_FAN_STAGE_ADJUSTMENT_SENSOR_ROCKER_TYPE0 = 0x11B0,
    FID_FAN_STAGE_ADJUSTMENT_SENSOR_ROCKER_TYPE7 = 0x11B7,
    FID_FAN_STAGE_ADJUSTMENT_SENSOR_PUSHBUTTON_TYPE0 = 0x11B8,
    FID_FAN_STAGE_ADJUSTMENT_SENSOR_PUSHBUTTON_TYPE7 = 0x11BF,
    FID_SWITCH_SENSOR_ROCKER_TYPE8 = 0x1200,
    FID_SWITCH_SENSOR_PUSHBUTTON_TYPE8 = 0x1201,
    FID_DIMMING_SENSOR_ROCKER_TYPE8 = 0x1202,
    FID_DIMMING_SENSOR_PUSHBUTTON_TYPE8 = 0x1203,
    FID_STAIRCASE_LIGHT_SENSOR_ROCKER_TYPE8 = 0x1204,
    FID_STAIRCASE_LIGHT_SENSOR_PUSHBUTTON_TYPE8 = 0x1205,
    FID_SCENE_SENSOR_ROCKER_TYPE8 = 0x1206,
    FID_SCENE_SENSOR_PUSHBUTTON_TYPE8 = 0x1207,
    FID_BLIND_SENSOR_ROCKER_TYPE8 = 0x1208,
    FID_BLIND_SENSOR_PUSHBUTTON_TYPE8 = 0x1209,
    FID_FORCE_ON_OFF_SENSOR_ROCKER_TYPE8 = 0x120A,
    FID_FORCE_ON_OFF_SENSOR_PUSHBUTTON_TYPE8 = 0x120B,
    FID_FORCE_UP_DOWN_SENSOR_ROCKER_TYPE8 = 0x120C,
    FID_FORCE_UP_DOWN_SENSOR_PUSHBUTTON_TYPE8 = 0x120D,
    FID_TIMER_ACTION_SENSOR_ROCKER_TYPE8 = 0x120E,
    FID_TIMER_ACTION_SENSOR_PUSHBUTTON_TYPE8 = 0x120F,
    FID_MEDIA_PLAYBACK_CONTROL_SENSOR_ROCKER_TYPE8 = 0x1210,
    FID_MEDIA_PLAY_PAUSE_SENSOR_PUSHBUTTON_TYPE8 = 0x1211,
    FID_MEDIA_VOLUME_SENSOR_ROCKER_TYPE8 = 0x1212,
    FID_MEDIA_VOLUME_UP_SENSOR_PUSHBUTTON_TYPE8 = 0x1213,
    FID_MEDIA_VOLUME_DOWN_SENSOR_PUSHBUTTON_TYPE8 = 0x1214,
    FID_MEDIA_NEXT_FAVORITE_SENSOR_PUSHBUTTON_TYPE8 = 0x1215,
    FID_MEDIA_NEXT_SONG_SENSOR_PUSHBUTTON_TYPE8 = 0x1216,
    FID_MEDIA_PREVIOUS_SONG_SENSOR_PUSHBUTTON_TYPE8 = 0x1217,
    FID_SWITCH_ACTUATOR_TYPE8 = 0x1808,
    FID_SWITCH_ACTUATOR_TYPE9 = 0x1809,
    FID_SWITCH_ACTUATOR_TYPE10 = 0x180A,
    FID_DIMMING_ACTUATOR_TYPE0 = 0x1810,
    FID_DIMMING_ACTUATOR_TYPE1 = 0x1811,
    FID_DIMMING_ACTUATOR_TYPE2 = 0x1812,
    ...
    FID_BLINDS_ACTUATOR_TYPE8 = 0x1828,
    FID_E_CONTACT_SWITCH_ACTUATOR_TYPE0 = 0x1830,
    FID_E_CONTACT_SWITCH_ACTUATOR_TYPE1 = 0x1831,
    FID_E_CONTACT_SWITCH_ACTUATOR_TYPE2 = 0x1832,
    FID_VENTILATION_SWITCH_ACTUATOR_TYPE0 = 0x1840,
    FID_PROXY_ROOM_TEMPERATURE_CONTROLLER_TYPE0 = 0x1C00,
    FID_HOUSEKEEPING_TYPE0 = 0x1F00,
    FID_HOUSEKEEPING_TYPE1 = 0x1F01,
    FID_PROXY_CLIENT_TYPE0 = 0x1F02,
    FID_HOUSEKEEPING_TYPE2 = 0x1F03,
