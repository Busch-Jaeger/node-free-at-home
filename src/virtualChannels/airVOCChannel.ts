...
export class AirVOCChannel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setVOC(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_INFO_VOC, value);
    }
