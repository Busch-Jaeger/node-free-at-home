...
export class AirTemperatureChannel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setTemperature(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_MEASURED_TEMPERATURE, value);
    }
