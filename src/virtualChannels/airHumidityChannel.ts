...
export class AirHumidityChannel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setHumidity(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_HUMIDITY, value);
    }
