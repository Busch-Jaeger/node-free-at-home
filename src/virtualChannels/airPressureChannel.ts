...
export class AirPressureChannel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setPressure(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_INFO_PRESSURE, value);
    }
