...
export class AirPM25Channel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setPM25(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_INFO_PM_2_5, value);
    }
