...
export class AirNO2Channel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setNO2(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_INFO_NO_2, value);
    }
