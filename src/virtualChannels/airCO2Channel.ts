...
export class AirCO2Channel extends Mixin(Channel, (EventEmitter as { new(): ChannelEmitter })) {
    ...
    public setCO2(value: string): Promise<void>  {
        return this.setDatapoint(PairingIds.AL_INFO_CO_2, value);
    }
